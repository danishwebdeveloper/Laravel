...
<xsl:template match="/">
  ...
  <div class="expl">
  	<h1>XML Sitemap</h1>
  	<p>
  	Generated by <a href="https://smseo.com/" target="_blank">smseo.com</a> , this is an XML Sitemap, meant for consumption by search engines.</p>
<p>You can find more information about XML sitemaps on <a href="http://sitemaps.org" rel="nofollow" target="_blank">sitemaps.org</a>.</p>
  ...
  <table align="center" style="width:100% !important;">
    <tr class="head">
      ...
      <th style="width:60%;text-align:left;">Image</th>
    ...
    <tr>
      ...
      <xsl:template match="image:image">
         ...
         <td><a href="#" target="_blank"><xsl:value-of select="image:loc"/></a></td>
      </xsl:template>
