...
<div class="wrapper">
	...
	@else
        ...
        @endphp
        @if (!empty($img))
        <div class="container-fluid p-0 center-align"> <img src="{{ $img }}" width="1350" height="450"  class="img-fluid" alt="Xray Blog Slider Image"> </div>
        @endif
        @endif
    ...
    @endphp
    @php
        $row = \App\Homedata::select('views')->first();
