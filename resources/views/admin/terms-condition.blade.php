      ...
      <div class="card mb-4">
        <div class="card-header">
          <div class="d-flex justify-content-between align-items-center">
            <div>
              <h6 class="fs-17 font-weight-600 mb-0">Terms Condition</h6>
            </div>
        ...
        <div class="card-body">
          ...
          @endif
          <form method="POST" action="{{ route('terms') }}" enctype="multipart/form-data">
            @csrf
            <div class="row">
              <div class="col-lg-8 col-md-8">
                <input type="hidden" name="id" value="{{ isset($data)?$data->id:''}}">
                <input type="hidden" name="page_name" value="{{ isset($data)?$data->page_name:'terms-condition'}}">
                ...
                <div class="form-group">
                  <label class="font-weight-600 req">Content (Urdu)</label>
                  <div>
