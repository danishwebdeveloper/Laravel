            ...
            <div class="row">
                              ...
                              <div class="form-rows">
                                  <table class="table table-bordered">
                                      ...
                                      <tbody id="sortable" class=" social m-tbc todo-list msortable ui-sortable">
                                          @php
                                          $ic = array("facebook" , "twitter","instagram" , "youtube" , "linkedin" , "pintrest");
                                         $rev_count = (count($links)==0) ? 0 : count($links) - 1;
                                          for ($n=0; $n<=5; $n++){ $link=( isset($links[$n][ "link" ])) ? $links[$n][ "link" ]: "" ; $icon=( isset($links[$n][ "icon" ])) ? $links[$n][ "icon" ]: $ic[$n] ; @endphp <tr class="tr-row">
                                              <td>{{ $n+1 }}</td>
                                              <td>
              ...
              <div class="col-lg-4 col-md-12">
                <div class="form-group col-lg-12 col-md-12">
                  <div class="card">
                    <div class="card-header card bg-secondary text-white">
                      <span><b class="req"> Author Image : <small> 100 x 100</small> </b> <a  class="text-white float-right" href="" ></a></span>
                    </div>
                    <div class="card-body">
