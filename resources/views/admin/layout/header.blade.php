            ...
            <div class="sidebar-body">
                <nav class="sidebar-nav">
                    <ul class="metismenu">
                        ...
                        <li class="{{ Request::segment(2)=='about' || Request::segment(2)=='contact' || Request::segment(2)=='terms-condition' || Request::segment(2)=='privacy-policy' || Request::segment(2)=='faqs'  ? 'mm-active' : '' }}">
                            <a class="has-arrow material-ripple" href="#">
                                <i class="typcn typcn-tabs-outline mr-2"></i>
                                CMS
                            </a>
                            <ul class="nav-second-level">
                                <li class="{{ Request::segment(2)=='contact' ? 'mm-active' : '' }}"><a href="{{ url('/'.admin.'/contact')}}">Contact</a></li>
                                ...
                                <li class="{{ Request::segment(2)=='faqs' ? 'mm-active' : '' }}"><a href="{{ url('/'.admin.'/faqs')}}">FAQs</a></li>
                            </ul>
                        </li>
                        @php
                        ...
                        <li class="{{ Request::segment(2)=='sidebar-settings' ? 'mm-active' : '' }}">
                            ...
                            <ul class="nav-second-level">
                                ...
                                <li class="{{ $pg== "privacy-policy" ? 'mm-active' : '' }}"><a href="{{ url('/'.admin.'/sidebar-settings?pg=privacy-policy')}}">Privacy Policy</a></li>
								<li class="{{ $pg =='terms-conditions' ? 'mm-active' : '' }}"><a href="{{ url('/'.admin.'/sidebar-settings?pg=terms-conditions')}}">Terms & Conditions</a></li>
								<li class="{{ $pg =='faqs' ? 'mm-active' : '' }}"><a href="{{ url('/'.admin.'/sidebar-settings?pg=faqs')}}">FAQs</a></li>
                            </ul>
                        </li>
                        <li class="{{ Request::segment(2)=='emails'  ? 'mm-active' : '' }}">
                            ...
                            <ul class="nav-second-level">
                                <li class="{{ Request::segment(2)=='emails' && Request::segment(3)=='' ? 'mm-active' : '' }}"><a href="{{ url('/'.admin.'/emails')}}">Emails</a></li>
                        ...
                        <li class="{{ Request::segment(2)=='authors' ? 'mm-active' : '' }}">
                        ...
                        <li class="{{ Request::segment(2)=='general-setting' || Request::segment(2)=='login-info' || Request::segment(2)=='footer' ? 'mm-active' : '' }}">
                            <a class="has-arrow material-ripple" href="#">
                            ...
                            <ul class="nav-second-level">
								...
								<li class="{{ Request::segment(2)=='footer' ? 'mm-active' : '' }}"><a href="{{url('/'.admin.'/footer')}}">Footer</a></li>
