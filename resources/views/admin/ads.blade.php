      ...
      <div class="card mb-4">
        <div class="card-header">
          <div class="d-flex justify-content-between align-items-center">
            <div>
              <h6 class="fs-17 font-weight-600 mb-0">Ads Settings</h6>
            </div>
            <div class="text-right">
               <div class="actions">
              {{--   <a href="{{ route('home') }}" class="btn {{ Request::segment(2)=='home'  &&  Request::segment(3)==''  ? 'btn-inverse' : 'btn-info' }} pull-right">Home</a>
                <a href="{{ route('home-ads') }}" class="btn {{ Request::segment(2)=='home-ads'  && Request::segment(3)==''  ? 'btn-inverse' : 'btn-info' }} pull-right">Home ads</a> --}}
              </div>
            </div>
          </div>
        </div>
              ...
              <div class="col-lg-10 col-md-10">
                ...
                <div class="form-group col-md-12 p-0">
                    ...
                    <div class="form-rows">
                      ...
                      <div class="new-Ads border row">
                        ...
                        <div class="form-group col-lg-5" style="text-align: center;">
                          <label class="font-weight-600 req">Ads Image {{ $n+1 }} :</label>
                          <br>
                  ...
                  <div style="text-align:right;">
                    <a href="" class="btn btn-success add-Ads"><i class="fa fa-plus"></i></a>
                  </div>
                </div>
                <div class="form-group col-md-12 p-0">
...
<script>
    ...
    var clone = '<div class="new-Ads border row">'+
                ...
                '<div class="form-group col-lg-5" style="text-align: center;">'+
                  '<label class="font-weight-600 req">Ads Image <span class="no" ></span> :</label>'+
                  '<br>'+
                  '<div class="uc-image" style="width:150px;height:150px;">'+
                        '<span class="clear-image-x">x</span>'+
