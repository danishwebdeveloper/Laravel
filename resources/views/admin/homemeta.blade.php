                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group col-12 col-md-8 p-0">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control tcount" data-count="tags" placeholder="TAG1 , TAG2 , TAG3" name="meta_tags" value="{{ (isset($m_data) and !empty($m_data))?$m_data->meta_tags:''}}">
                                        <div class="input-group-append">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-lg-6">
                                        ...
                                        <div class="uc-image" style="width:150px;height:150px;">
                                            ...
                                            <input type="hidden" name="og_image" value="{{ (isset($m_data) and !empty($m_data))?$m_data->og_image:''}}">
                                             @php
                                ...
                                <div class="card col-10">
                                   <div class="card-header card bg-secondary text-white">
                                        <b> Home Page Slider <small>Size : 1350 x 530 </small></b>
                                    </div> 
                                                    ...
                                                    <tbody id="sortable" class=" home-design m-tbc todo-list msortable ui-sortable">
                                                        ...
                                                        <tr class="tr-row">
                                                            ...
                                                            <td>
                                                                ...
                                                                $res2 = array();
                                                                $res = array();
                                                                $res = DB::table("blogcats")->select('id' , 'title' , 'slug')->orderBy( 'tb_order' )->get();
                                                                $res2 = array(
                                                                array("id"=>"popular1","title"=>"Popular 1","slug"=>"popular-1"),
                                                                array("id"=>"popular2","title"=>"Popular 2","slug"=>"popular-2"),
                                                                array("id"=>"popular3","title"=>"Popular 3","slug"=>"popular-3")
                                                                );
...
'<div class="new-schema border row">' +
    ...
    '<div class="col-lg-12">' +
        '<div class="form-row">' +
            '<div class="form-group col-lg-12">' +
                '<div class="flex-center"><b>  <span class="no"> </span> &nbsp; - &nbsp;</b> <input type="text" name="type[]" value=""  > </div> <br>' +
